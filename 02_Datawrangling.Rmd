...
Fake_cccu_complete1 <- Fake_cccu_complete1 %>%
  mutate(Avoid_r = ifelse(AVOID == "(1) Not at all important to avoid pregnancy 1" | AVOID3 == "(1) Not at all important to avoid pregnancy 1", 1,ifelse(AVOID == "(2) 2" | AVOID3 == "(2) 2", 2,ifelse(AVOID == "(3) 3" | AVOID3 == "(3) 3", 3,ifelse(AVOID == "(4) 4" | AVOID3 == "(4) 4", 4, ifelse(AVOID == "(5) 5" | AVOID3 == "(5) 5" , 5, ifelse(AVOID == "(6) Very important to avoid pregnancy 6" | AVOID3 == "(6) Very important to avoid pregnancy 6",6, NA))))))) 
...
Fake_cccu_complete1 <- Fake_cccu_complete1 %>%
  mutate(pregnant_between_waves = ifelse(PREG == "(1) I had a miscarriage" |
                                         ...
                                         ifelse(CURRENT == "(2) I am currently pregnant." |
                                                  CURRENT == "(3) I might currently be pregnant", 1, ifelse(PREG == "(-1) Refused", NA, 0))))
...
Fake_cccu_complete1 <- Fake_cccu_complete1 %>%
  mutate(had_baby_between_waves = ifelse(PREG=="(3) I had a baby" | CURRENT == "(1) I had a baby within the last 3 months", 1, ifelse(PREG == "(-1) Refused", NA, 0)))
