...
Fake_cccu_complete1<- Fake_cccu_complete1 %>%
  mutate(NKIDS = recode(NBIRTHS,
                                    "(0) 0"="0",
                                  "(1) 1"="1",
                                 "(2) 2" = "2",
                                 "(3) 3" = "3",
                                 "(4) 4 or more" = "4"))
table(Fake_cccu_complete1$NKIDS)
#factorize
Fake_cccu_complete1$NKIDS<-factor(Fake_cccu_complete1$NKIDS, levels = c(0,1,2,3,4), labels = c("0", "1", "2", "3", "4 or more"))
...
table(Fake_cccu_complete1$had_baby_between_waves)#happy!
#factorize
