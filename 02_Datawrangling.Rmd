...
cccu_complete1 <- cccu_complete1 %>%
  mutate(
    DEGREE_recode = recode(
      ...
      "(02) 1st, 2nd, 3rd, or 4th grade" = "1",
      "(03) 5th or 6th grade" = "1",
      "(04) 7th or 8th grade" = "1",
      "(05) 9th grade" = "1",
      "(06) 10th grade" = "1",
      "(07) 11th grade" = "1",
      "(08) 12th grade NO DIPLOMA" = "1",
      "(09) HIGH SCHOOL GRADUATE - high school DIPLOMA or the equivalent (GED)" = "2",
      "(10) Some college, no degree" = "3",
      "(11) Associate degree" = "4",
      "(12) Bachelors degree" = "5",
      "(13) Masters degree" = "6",
      "(14) Professional or Doctorate degree" = "7"
    ))
...
cccu_complete1$DEGREE_recode <-
  factor(
    ...
    levels = c(1, 2,3,4,5,6,7),
    labels = c(
      "no formal education up to 12th grade without diploma",
...
cccu_complete1<- cccu_complete1 %>%
  mutate(hc = factor(as.character(hc),
                     levels = c("non_hc", "hc"),
                     labels = c("non_hc", "hc")),
         sex_freq = factor(str_replace_all(sex_freq, " ", "_"),
                           levels = c("No_sex", "Once", "2-5_times", "6-10_times", "11_or_more_times"),
                           labels = c("No_sex", "Once", "2-5_times", "6-10_times", "11_or_more_times")))
```
