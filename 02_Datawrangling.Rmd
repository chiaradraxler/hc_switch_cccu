...
Fake_cccu_complete1 <- Fake_cccu_complete1 %>%
  mutate(contra_satisfaction = ifelse(hc = "hc", pmax(Q23D_PILL, Q23D_PATCH, Q23D_DEPO, Q23D_IMPLANT, Q23D_RING, na.rm = TRUE), pmax(RSAT1, RSAT2, RSAT3, RSAT4, RSAT5, na.rm = TRUE)
