...
R1_m4_sum = summary(R1_ma_4)

#r2
R2_ma_4 <- brm(file = "models/R2_ma_4.Rds")

R2_m4_sum = summary(R2_ma_4)

#r3
R3_ma_4 <- brm(file = "models/R3_ma_4.Rds")

R3_m4_sum = summary(R3_ma_4)
```
...
m1_forest_plot$group = rep("model_1", 2)
...
R1_m1_forest_plot$group = rep("R1_model_1", 2)
...
R2_m1_forest_plot$group = rep("R2_model_1", 2)
...
R3_m1_forest_plot$group = rep("R3_model_1", 2)
...
m2_forest_plot$group = rep("model_2", 4)
...
R1_m2_forest_plot$group = rep("R1_model_2", 4)
...
R2_m2_forest_plot$group = rep("R2_model_2", 4)
...
R3_m2_forest_plot$group = rep("R3_model_2", 4)
...
m3_forest_plot$group = rep("model_3", 12)
...
R1_m3_forest_plot$group = rep("R1_model_3", 4)
...
R2_m3_forest_plot$group = rep("R2_model_3", 4)
...
R3_m3_forest_plot$group = rep("R3_model_3", 4)
...
####m4
```{r}
m4_confint = confint(m4, parm = c("(Intercept)",
                                               "hcnon_hc",
                                               "contra_satis",
                                               "sexual_satisfaction",
...
rn = rownames(m4_confint)
m4_confint = data.frame(m4_confint)

colnames(m4_confint) = c("lower", "upper")
m4_confint$predictor = rn


m4_forest_plot = data.frame(predictor = names(m4$coefficients),
  estimate = as.numeric(as.character(m4$coefficients)))

m4_forest_plot = left_join(m4_forest_plot, m4_onfint, by = "predictor")

m4_forest_plot$group = rep("model_4", 12)
```

####m4 in robustnessanalyses
```{r}
#R1
R1_m4_confint = confint(R1_ma_4, parm = c("(Intercept)",
                                               "hcnon_hc",
                                               "contra_satis",
                                               "sexual_satisfaction",
                                               "sex_freq2-5 times", "sex_freq6-10 times",
...
rn = rownames(R1_m4_confint)
R1_m4_confint = data.frame(R1_m4_confint)

colnames(R1_m4_confint) = c("lower", "upper")
R1_m4_confint$predictor = rn


R1_m4_forest_plot = data.frame(
  predictor = names(R1_m4_sum$coefficients[,1]),
  estimate = as.numeric(as.character(R1_m4_sum$coefficients[,1])))

R1_m4_forest_plot = left_join(R1_m4_forest_plot, R1_m4_confint, by = "predictor")

R1_m4_forest_plot$group = rep("R1_model_4", 71)



#R2
R2_m4_confint = confint(R2_ma_4, parm = c("(Intercept)",
                                               "hcnon_hc",
                                               "contra_satis",
                                               "sexual_satisfaction",
                                               "sex_freq2-5 times", "sex_freq6-10 times",
...
rn = rownames(R2_m4_confint)
R2_m4_confint = data.frame(R2_m4_confint)

colnames(R2_m4_confint) = c("lower", "upper")
R2_m4_confint$predictor = rn


R2_m4_forest_plot = data.frame(
  predictor = names(R2_m4_sum$coefficients[,1]),
  estimate = as.numeric(as.character(R2_m4_sum$coefficients[,1])))

R2_m4_forest_plot = left_join(R2_m4_forest_plot, R2_m4_confint, by = "predictor")

R2_m4_forest_plot$group = rep("R2_model_4", 71)


#R3
R3_m4_confint = confint(R3_ma_4, parm = c("(Intercept)",
                                               "hcnon_hc",
                                               "contra_satis",
                                               "sexual_satisfaction",
                                               "sex_freq2-5 times", "sex_freq6-10 times",
...
rn = rownames(R3_m4_confint)
R3_m4_confint = data.frame(R3_m4_confint)

colnames(R3_m4_confint) = c("lower", "upper")
R3_m4_confint$predictor = rn


R3_m4_forest_plot = data.frame(
  predictor = names(R3_m4_sum$coefficients[,1]),
  estimate = as.numeric(as.character(R3_m4_sum$coefficients[,1])))

R3_m4_forest_plot = left_join(R3_m4_forest_plot, R3_m4_confint, by = "predictor")

R3_m4_forest_plot$group = rep("R3_model_4", 71)
