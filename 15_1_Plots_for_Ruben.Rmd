...
forest_plot_data_rub$predictor = factor(forest_plot_data_rub$predictor,
                                    levels = c("Intercept",
                                               "hcnon_hc",
                                               "contra_satis",
...
forest_plot_data_rub$group = factor(
  forest_plot_data_rub$group,
  levels = 
    c(
    "model_1",
    "model_2",
...
forest_plot_data_rub <- forest_plot_data_rub %>%
...
forest_ma_rub <- ggplot(
  data = forest_plot_data_rub %>%
...
ggsave("forest_ma_rub.pdf", forest_ma_rub, width = 23, height = 12, units = "cm", dpi = 300)
ggsave("forest_ma_rub.png", forest_ma_rub, width = 23, height = 12, units = "cm", dpi = 300)
...
forest_ma_ra <- ggplot(
  ...
  scale_fill_manual(
    name = "Analyses",
    breaks = c("shape_1", "shape_2", "shape_3", "shape_4"),
    labels = 
      c(
      "Main Analyses",
...
ggsave("forest_ma.pdf", forest_ma_ra, width = 60, height = 30, units = "cm", dpi = 300)
ggsave("forest_ma.png", forest_ma_ra, width = 60, height = 30, units = "cm", dpi = 300)
...
```{r}
#without robustness analyses
sa_forest_plot_data_rub = rbind(
  sa_m2_forest_plot,
  sa_m3_forest_plot,
  sa_m4_forest_plot
)

sa_forest_plot_data_rub$predictor = factor(sa_forest_plot_data_rub$predictor,
                                    levels = c("Intercept",
                                               "contra_satis",
                                               "hc_dur",
                                               "contra_satis:hc_dur",
...
sa_forest_plot_data_rub$group = factor(
  sa_forest_plot_data_rub$group,
  levels = 
    c(
    "sa_model_2",
    "sa_model_3",
...
#give group for color:
sa_forest_plot_data_rub <- sa_forest_plot_data_rub %>%
...
forest_sa_rub <- ggplot(
  data = sa_forest_plot_data_rub %>%
    filter(predictor != "(Intercept)"),
  aes(
    x = predictor,
    y = estimate,
...
ggsave("forest_sa_rub.pdf", forest_sa_rub, width = 23, height = 12, units = "cm", dpi = 300)
ggsave("forest_sa_rub.png", forest_sa_rub, width = 23, height = 12, units = "cm", dpi = 300)
...
ggsave("forest_sa.pdf", forest_sa_ra, width = 60, height = 30, units = "cm", dpi = 300)
ggsave("forest_sa.png", forest_sa_ra, width = 60, height = 30, units = "cm", dpi = 300)
```
