...
```{r}
table(Fake_cccu_complete1$contra_satis) #@CHIARA@ Variable heißt contra_satis
...
#IUD & non-hormonal 
Fake_cccu_complete1 <- Fake_cccu_complete1 %>%
 mutate(exclusion_IUD = ifelse(is.na(IUD) & hc == "0", 1,0)) #@CHIARA@ this doesnt work? why is.na(IUD)?
