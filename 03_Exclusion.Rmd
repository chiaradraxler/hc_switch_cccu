...
#exclude from df
cccu_complete6_version1 <-cccu_complete5 %>%
  filter(exclusion_missing_selection !=1)

cccu_complete6_version2 <-cccu_complete5 %>%
  filter(!is.na(AGE), !is.na(DEGREE_recode), !is.na(POVRATE), !is.na(HLTHPROB_recode),
           !is.na(MEDPROB_recode), !is.na(GAPINS_recode), !is.na(TYPEINS_recode),
           !is.na(NKIDS_t1), !is.na(pregnant_between_waves),
           !is.na(had_baby_between_waves), !is.na(FEELPG_recode), !is.na(Avoid_r),
           !is.na(rel_dur_factor))

cccu_complete6 -> cccu_complete6_version1
