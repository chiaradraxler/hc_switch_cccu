...
summary(R1_sa_2)
confint(R1_sa_3, method = "Wald", level = .997)
plot(allEffects(R1_sa_2))
```
...
```{r}
R3_sa_m2 <- glmer(switch ~ contra_satis * hc_dur + (1| CASEID), family = binomial, data = cccu_3_s, control=glmerControl(optimizer="bobyqa"))
