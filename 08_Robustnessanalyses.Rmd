...
summary(R1_ma_4)
(confint(R1_ma_4, parm = "contra_satis", method = "Wald", level = .997))
(confint(R1_ma_4, parm = "hcnon_hc:contra_satis", method = "Wald", level = .997))
(confint(R1_ma_4, parm = "hcnon_hc", method = "Wald", level = .997))
...
summary(R2_ma_4)
(confint(R2_ma_4, parm = "contra_satis", method = "Wald", level = .997))
(confint(R2_ma_4, parm = "hcnon_hc:contra_satis", method = "Wald", level = .997))
(confint(R2_ma_4, parm = "hcnon_hc", method = "Wald", level = .997))
...
summary(R3_ma_4)
(confint(R3_ma_4, parm = "contra_satis", method = "Wald", level = .997))
(confint(R3_ma_4, parm = "hcnon_hc:contra_satis", method = "Wald", level = .997))
(confint(R3_ma_4, parm = "hcnon_hc", method = "Wald", level = .997))
