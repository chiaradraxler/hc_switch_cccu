...
table(cccu_MA_t1_hc$CONDOMR)
table(cccu_MA_t1_hc$VASECTOMY)
table(cccu_MA_t1_hc$WITHDRAWR)
table(cccu_MA_t1_hc$NFPR)
table(cccu_MA_t1_hc$SPERMR)
table(cccu_MA_t1_hc$NOBARRIER)
