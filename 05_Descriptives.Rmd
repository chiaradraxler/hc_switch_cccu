...
t1_comp_inex %>% cohens_d(contra_satis ~ exclude, var.equal = TRUE)
...
t1_comp_inex %>% cohens_d(sexual_satisfaction ~ exclude, var.equal = TRUE)
```
...
t1_comp_inex %>% cohens_d(AGE ~ exclude, var.equal = TRUE)
```
...
t1_comp_inex %>% cohens_d(POVRATE ~ exclude, var.equal = TRUE)
```
...
t1_comp_inex %>% cohens_d(Avoid_r ~ exclude, var.equal = TRUE)
```
...
t1_comp_inex %>% cohens_d(FEELPG_recode ~ exclude, var.equal = TRUE)
```
...
t1_comp_inex %>% cohens_d(rel_dur ~ exclude, var.equal = TRUE)
```
