...
R1_sa_2 <- brm(file = "models/R1_sa_2.Rds")
R2_sa_2 <- brm(file = "models/R2_sa_2.Rds")
R3_sa_2 <- brm(file = "models/R3_sa_2.Rds")

R1_sa_3 <- brm(file = "models/R1_sa_3.Rds")
R2_sa_3 <- brm(file = "models/R2_sa_3.Rds")
R3_sa_3 <- brm(file = "models/R3_sa_3.Rds")

R1_sa_4 <- brm(file = "models/R1_sa_4.Rds")
R2_sa_4 <- brm(file = "models/R2_sa_4.Rds")
R3_sa_4 <- brm(file = "models/R3_sa_4.Rds")
```
