...
exp(confint(m4_lm, method = "boot", level = .997))
...
#for hc vs. non-hc 
evalue(OR(0.05881423,rare=FALSE),lo= 0.0038230611,  hi=0.7217084)
...
#model 4
#for hc vs. non-hc 
evalue(OR(0.1305422699437,rare=FALSE),lo=,  hi=)

#for contra_satis
evalue(OR(0.5539576142243,rare=FALSE),lo= ,  hi=)

#hc:contra_satis
evalue(OR(1.3873215961381,rare=FALSE),lo= ,  hi=)
