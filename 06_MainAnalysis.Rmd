...
(m4_lm$coefficients)
(confint(m4_lm, parm = "contra_satis", method = "Wald", level = .997))
(confint(m4_lm, parm = "hcnon_hc:contra_satis", method = "Wald", level = .997))
(confint(m4_lm, parm = "hcnon_hc", method = "Wald", level = .997))
