...
plot_model(m3, type = "pred", terms = c("contra_satis", "hc"), ci.lvl = 0.997)  +
...
plot_model(m3, type = "pred", terms = c("sexual_satisfaction", "hc"), ci.lvl = 0.997)  +  labs(color = "Group",  fill = "Group") +
  scale_fill_manual(
    values = c("red", "blue"),
    name = "Group",
    breaks = c("hc", "non_hc"),
...
plot_model(m3, type = "pred", terms = c("sex_freq", "hc"), ci.lvl = 0.997)  +
  labs(color = "Group",  fill = "Group") +
  scale_fill_manual(
    values = c("red", "blue"),
    name = "Group",
...
forest_plot_data2$predictor = factor(forest_plot_data2$predictor,
                                    ...
                                    labels = c("(Intercept)",
                                               ...
                                               "Hormonal Contraceptive Use : Contraceptive Satisfaction",
                                               "Sexual Satisfaction",
                                               "Sexual Frequency -5 times", "Sexual Frequency 6-10 times",
                                               "Sexual Frequency 11 or more times",
                                               "Hormonal Contraceptive Use : Sexual Satisfaction",
                                               "Hormonal Contraceptive Use : Sexual Frequency 2-5 times",
                                               "Hormonal Contraceptive Use : Sexual Frequency 6-10 times",
                                               "Hormonal Contraceptive Use : Sexual Frequency 11 or more times"))
...
sa_forest_plot_data$predictor = factor(sa_forest_plot_data$predictor,
                                    levels = c("(Intercept)",                                               "contra_satis", "hc_dur",
                                               "sexual_satisfaction",
                                               "sex_freq2-5 times", "sex_freq6-10 times",
                                               "sex_freq11 or more times", 
                                               "contra_satis:hc_dur"),
                                    labels = c("(Intercept)",                                               "Contraceptive Satisfaction", "Contraceptive Duration",
                                               "Sexual Satisfaction",
                                               "Sexual Frequency 2-5 times", "Sexual Frequency 6-10 times",
                                               "Sexual Frequency 11 or more times", 
                                               "Contraceptive Satisfaction : Contraceptive Duration"))
