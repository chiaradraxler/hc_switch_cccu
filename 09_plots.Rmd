...
hc_dur<-
  plot_model(sa_m3, type = "pred",  grid = TRUE, show.legend = TRUE, terms = c("contra_satis","hc_dur[0, 10,20,30,40]"), ci.lvl = 0.997)  +
  labs(color = "Group",  fill = "Group") +

  labs(y = "Probability to Switch", title = "") +
  scale_x_discrete("Contraceptive Satisfaction",
                   limits = c("1", "2", "3", "4"))+
  legend_style(inside = TRUE, pos = "right")+
    apatheme
...
forest_plot_data2$predictor = factor(forest_plot_data2$predictor,
                                    ...
                                    labels = c("(Intercept)",
                                               ...
                                               "Sexual Satisfaction",
                                               "Sexual Frequency 2-5", "Sexual Frequency 6-10",
                                               "Sexual Frequency 11+",
                                               "HC: Sexual Satisfaction",
                                               "HC: Sexual Frequency 2-5",
                                               "HC: Sexual Frequency 6-10",
                                               "HC: Sexual Frequency 11+"))
...
sa_forest_plot_data$predictor = factor(sa_forest_plot_data$predictor,
                                    levels = c("(Intercept)",                                               "contra_satis", "hc_dur",
                                               ...
                                               "sex_freq11 or more times", 
                                               "contra_satis:hc_dur"),
                                    labels = c("(Intercept)",                                               "Contraceptive Satisfaction", "HC-Dur",
                                               "Sexual Satisfaction",
                                               "Sexual Frequency 2-5", "Sexual Frequency 6-10",
                                               "Sexual Frequency 11+", 
                                               "Contraceptive Satisfaction : HC-Dur"))
